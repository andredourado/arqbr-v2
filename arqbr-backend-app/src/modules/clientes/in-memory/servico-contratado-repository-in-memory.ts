...
class ServicoContratadoRepositoryInMemory implements IServicoContratadoRepository {
  ...
  async list (
    ...
    filteredServicosContratados = filteredServicosContratados.filter((servicoContratado) => {
      if (servicoContratado.descricao.includes(search)) return true
  ...
  async select (filter: string): Promise<HttpResponse> {
    ...
    filteredServicosContratados = filteredServicosContratados.filter((servicoContratado) => {
      if (servicoContratado.descricao.includes(filter)) return true
  ...
  async update ({
    ...
    this.servicosContratados[index].descricao = descricao
