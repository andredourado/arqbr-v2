...
async function create() {
  ...
  await connection.query(
    `INSERT INTO menu_options (
      ...
      ('55655f2b-693c-4efb-a465-afedb938a507', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006004', 'Documentos Digitais', '/documentos-digitais', 'List', 'digitalizacao-documentos-digitais', 'now()', 'now()'),
			...
			('d27019f9-974c-439c-bd4f-c9e040e21e01', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006007', 'Definição de Extrações', '/definicao-extracao', 'List', 'definicao-extracao', 'now()', 'now()'),
  ...
  await connection.query(
    `INSERT INTO profile_options (
      ...
      ('d72ffaae-29f1-47cb-93fb-19f2199dc4ac', '3c99decf-f975-4b16-b552-0747afd397a3', 'digitalizacao-caixas-quebras', true, 'now()', 'now()'),
			...
			('8160fadb-e16a-4282-8281-76b4e739508e', '3c99decf-f975-4b16-b552-0747afd397a3', 'definicao-extracao', true, 'now()', 'now()'),
