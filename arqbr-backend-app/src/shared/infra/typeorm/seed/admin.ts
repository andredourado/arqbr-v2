...
async function create() {
  ...
  await connection.query(
    `INSERT INTO menu_options (
      ...
      ('9b3c0b19-c02e-45af-9597-d2360b8a26b3', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006003', 'Quebras de Caixas', '/caixas-quebras', 'List', 'digitalizacao-caixas-quebras', 'now()', 'now()'),
			...
			('f026e270-3e4a-484f-8d85-ec670d189793', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006006', 'Quebra Manual', '/quebra-manual', 'List', 'quebra-manual', 'now()', 'now()'),
			('47e0b4bb-3feb-4f13-a2e9-7b30ba590ba7', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006007', 'Ajuste Manual', '/ajuste-manual', 'List', 'ajuste-manual', 'now()', 'now()'),
  ...
  await connection.query(
    `INSERT INTO profile_options (
      ...
      ('0471bddc-de4c-42d1-a778-b67086796de1', '3c99decf-f975-4b16-b552-0747afd397a3', 'security-navigations', true, 'now()', 'now()'),
			...
			('8209a5e3-4422-46cc-af56-f6622892f958', '3c99decf-f975-4b16-b552-0747afd397a3', 'digitalizacao-caixas-quebras', true, 'now()', 'now()'),
			...
			('ccd7ba3a-7917-41a1-8208-016db22ce359', '3c99decf-f975-4b16-b552-0747afd397a3', 'quebra-manual', true, 'now()', 'now()'),
			('7c4450b2-e8fa-4cac-b453-21e13a356673', '3c99decf-f975-4b16-b552-0747afd397a3', 'ajuste-manual', true, 'now()', 'now()'),
