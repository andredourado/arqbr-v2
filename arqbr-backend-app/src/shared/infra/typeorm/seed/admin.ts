  ...
  await connection.query(
    `INSERT INTO menu_options (
      ...
      ('0471bddc-de4c-42d1-a778-b67086796de1', '5aefe650-10a3-4e0d-a018-4704975d84b6', '001008', 'Navegação', '/navigations', 'List', 'security-navigations', 'now()', 'now()'),
			...
			('55655f2b-693c-4efb-a465-afedb938a507', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006003', 'Documentos Digitais', '/documentos-digitais', 'List', 'digitalizacao-documentos-digitais', 'now()', 'now()'),
			('14d5bff1-8ca9-4802-8fb0-cf8c71ea79e8', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006004', 'Campos dos Documentos Digitais', '/documentos-digitais-campos', 'List', 'digitalizacao-documentos-digitais-campos', 'now()', 'now()'),
			('f026e270-3e4a-484f-8d85-ec670d189793', '9a3835cb-1e2d-4370-80b7-3dcbcbd20b51', '006005', 'Quebra Manual', '/quebra-manual', 'List', 'quebra-manual', 'now()', 'now()'),
