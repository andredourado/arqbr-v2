...
export class TimeColetaEditComponent implements OnInit, OnDestroy {
  ...
  getLiterals() {
    this.languagesService.getLiterals({ type: 'edit', module: 'coleta', options: 'timeColeta'})
      .subscribe({
    ...
    this.pageActions.push(
      {
        ...
        action: () => this.save(this.timeColetaForm.value)
      },
      {
        label: this.literals.saveAndNew,
        action: () => this.save(this.timeColetaForm.value, true)
      },
      {
