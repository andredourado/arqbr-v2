...
export class TipoAfastamentoEditComponent implements OnInit, OnDestroy {
  ...
  getLiterals() {
    this.languagesService.getLiterals({ type: 'edit', module: 'comum', options: 'tipoAfastamento'})
      .subscribe({
    ...
    this.pageActions.push(
      {
        ...
        action: () => this.save(this.tipoAfastamentoForm.value)
      },
      {
        label: this.literals.saveAndNew,
        action: () => this.save(this.tipoAfastamentoForm.value, true)
      },
      {
