...
export class PessoaEditComponent implements OnInit, OnDestroy {
  ...
  getLiterals() {
    this.languagesService.getLiterals({ type: 'edit', module: 'pessoas', options: 'pessoa'})
      .subscribe({
    ...
    this.pageActions.push(
      {
        ...
        action: () => this.save(this.pessoaForm.value)
      },
      {
        label: this.literals.saveAndNew,
        action: () => this.save(this.pessoaForm.value, true)
      },
      {
