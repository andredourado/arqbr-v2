...
@injectable()
class DeleteRastreamentoDocumentoUseCase {
  constructor(
  ...
  async execute(id: string): Promise<HttpResponse> {
    const rastreamentoDocumento = await this.rastreamentoDocumentoRepository.delete(id)

    return rastreamentoDocumento
  }
}

export { DeleteRastreamentoDocumentoUseCase }
