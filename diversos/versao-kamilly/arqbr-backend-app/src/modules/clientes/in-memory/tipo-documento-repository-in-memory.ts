...
class TipoDocumentoRepositoryInMemory implements ITipoDocumentoRepository {
  ...
  async update ({
    ...
    this.tiposDocumento[index].contratoId = contratoId
    this.tiposDocumento[index].departamentoId = departamentoId
    this.tiposDocumento[index].descricao = descricao
    this.tiposDocumento[index].composicaoLoteId = composicaoLoteId
    this.tiposDocumento[index].numeroPaginas = numeroPaginas
    this.tiposDocumento[index].mascaraNomeArquivo = mascaraNomeArquivo
