...
import { CreateTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/create-tipo-documento/create-tipo-documento-controller'
import { ListTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/list-tipo-documento/list-tipo-documento-controller'
import { CountTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/count-tipo-documento/count-tipo-documento-controller'
import { SelectTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/select-tipo-documento/select-tipo-documento-controller'
import { IdSelectTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/id-select-tipo-documento/id-select-tipo-documento-controller'
import { GetTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/get-tipo-documento/get-tipo-documento-controller'
import { UpdateTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/update-tipo-documento/update-tipo-documento-controller'
import { DeleteTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/delete-tipo-documento/delete-tipo-documento-controller'
import { MultiDeleteTipoDocumentoController } from '@modules/clientes/use-cases/tipo-documento/multi-delete-tipo-documento/multi-delete-tipo-documento-controller'
...
tiposDocumentoRoutes.get('/', ensureAuthenticated, listTipoDocumentoController.handle)
